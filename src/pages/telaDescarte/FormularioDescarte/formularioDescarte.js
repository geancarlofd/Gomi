...
function FormularioDescarte(props) {
  ...
  const [nomeUser, setNomeUser] = useState(props.nomeUser);
  const [uidUser, setUidUser] = useState(props.uidUser);
    ...
    <table cellPadding="10" className="table-tamanho">
      ...
      <tr>
        <td /* Campo Forma de Descarte */>
          <FormGroup row>
            <Col sm={30}>
              <Input type="select" name="select" id="exampleSelect2" onChange={(e) => { setTipoLixoDescarte(e.target.value) }}>
        ...
        <td /* Campo Tipo do Lixo */>
          <FormGroup row>
            <Col sm={30}>
              <Input type="select" name="select" id="exampleSelect2" onChange={(e) => { setFormaDescarte(e.target.value) }}>
